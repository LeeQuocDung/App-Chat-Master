    ...
    <div class="row w-100 justify-content-center align-items-center flex-column-reverse flex-md-row animate__animated animate__fadeIn">
      <div class="col-12 col-md-4">
        <div>
          ...
          <p class="small text-black-50">Hy vọng ai đó đang nhớ bạn ở đó.</p>
        </div>
        <div>
          <div class="card shadow">
            <div class="card-body">
              <form @submit.prevent="login">
                ...
                <div class="mb-3">
                  <button class="btn btn-success w-100"><span class="spinner-grow spinner-grow-sm me-2" role="status" v-if="isLoging"></span>Đăng nhập</button>
                </div>
              </form>
              <slot></slot>
            </div>
